    ...
    <footer className="bg-[#0f172a] text-white pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-orange-500 rounded-xl flex items-center justify-center text-white font-bold shadow-lg shadow-orange-500/20">A</div>
              <span className="font-bold text-2xl tracking-tight">Aegir</span>
            </div>
            ...
            <div className="space-y-4 text-gray-400">
              ...
              <div className="flex items-start space-x-3 group">
                ...
                <a href="mailto:hello@aegir.in" className="hover:text-white transition-colors">hello@aegir.in</a>
              </div>
              {/* Phone */}
              <div className="flex items-start space-x-3 group">
                <svg className="w-5 h-5 text-orange-500 mt-0.5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>© 2026 Aegir Smart Water. All rights reserved.</p>
